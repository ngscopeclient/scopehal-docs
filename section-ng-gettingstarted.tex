...
\href{https://vulkan.lunarg.com/doc/sdk/1.3.275.0/linux/getting_started_ubuntu.html}{.deb packaged SDK release} instead of following the instructions below.
...
\begin{lstlisting}[language=sh, numbers=none]
pacman -S mingw-w64-ucrt-x86_64-libsigc++ mingw-w64-ucrt-x86_64-cairomm mingw-w64-ucrt-x86_64-gtkmm3 mingw-w64-ucrt-x86_64-yaml-cpp mingw-w64-ucrt-x86_64-glfw mingw-w64-ucrt-x86_64-catch
\end{lstlisting}
