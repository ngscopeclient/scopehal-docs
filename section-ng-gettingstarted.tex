...
\href{https://vulkan.lunarg.com/doc/sdk/1.3.268.0/linux/getting_started_ubuntu.html}{.deb packaged SDK release} instead
...
rm -f vulkansdk-linux-x86_64-1.3.268.0.tar.xz
export VULKAN_SDK=~/vulkan/1.3.268.0/x86_64
