...
packages for a limited set of platforms (currently Ubuntu 20.04, 22.04, 24.04, Arch, Fedora, Debian oldstable, Debian stable,
MacOS, and Windows) are automatically built each commit as part of the GitHub CI pipeline. These packages are not
signed and may
