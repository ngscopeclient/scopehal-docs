...
work, it is necessary to either open a saved session (\menustyle{File | Open}), import waveforms from an external data
file (\menustyle{File | Import}), connect to an instrument (\menustyle{File | Connect}), or reconnect to a recently
used instrument (\menustyle{File | Recent Instruments}).
