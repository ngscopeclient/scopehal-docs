...
libsigc++-2.0-dev libyaml-cpp-dev catch2 libglfw3-dev curl xzip libhidapi-dev
\end{lstlisting}
...
Basic requirements:
\begin{lstlisting}[language=sh, numbers=none]
sudo dnf install git gcc g++ cmake make pkgconf gtk3-devel \
libsigc++30-devel yaml-cpp-devel catch-devel glfw-devel hidapi-devel
\end{lstlisting}
...
\begin{lstlisting}[language=sh, numbers=none]
apk add git gcc g++ cmake make pkgconf gtk+3.0-dev libsigc++-dev \
...
\begin{lstlisting}[language=sh, numbers=none]
brew install pkg-config libsigc++ glfw cmake yaml-cpp glew catch2 libomp hidapi libpng
\end{lstlisting}
...
\begin{lstlisting}[language=sh, numbers=none]
pacman -S mingw-w64-ucrt-x86\_64-libsigc++ mingw-w64-ucrt-x86\_64-yaml-cpp mingw-w64-ucrt-x86\_64-glfw mingw-w64-ucrt-x86\_64-catch mingw-w64-ucrt-x86\_64-hidapi
\end{lstlisting}
