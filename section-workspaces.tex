...
future. You can still dock and rearrange dialogs within the top-level application window as you see fit.

\section{Workspaces}

To create more complex windowing layouts, you may find it helpful to create \emph{workspaces} via the
\menustyle{Window | New Workspace} menu.
