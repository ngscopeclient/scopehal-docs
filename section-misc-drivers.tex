...
This driver provides a 32-bit read/write GPIO interface to the APB\_GPIO FPGA IP from antikernel-ipcores, via
via \href{https://github.com/ngscopeclient/scopehal-akldebug-bridge}{scopehal-akldebug-bridge}.

\subsection{akl.vio}

This driver provides a multi-bit digital I/O interface with up to eight input and eight output ports to the APB\_VIO
