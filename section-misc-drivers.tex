...
This driver provides a 32-bit read/write GPIO interface to the \verb|APB_GPIO| FPGA IP from antikernel-ipcores, via
via \href{https://github.com/ngscopeclient/scopehal-akldebug-bridge}{scopehal-akldebug-bridge}.

\subsection{akl.vio}

This driver provides a multi-bit digital I/O interface with up to eight input and eight output ports to the \verb|APB_VIO|
FPGA IP from antikernel-ipcores, via \href{https://github.com/ngscopeclient/scopehal-akldebug-bridge}{scopehal-akldebug-bridge}.
